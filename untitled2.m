%% Clear command window and start the timer
close all; clc; tic; 
...
axis([-15,15,-15,15,0,32]); camlight; lighting gouraud;
...
Nb = 5; r = rand(3,Nb);  xballs = -14+r(1,:)*28; yballs = -14+r(2,:)*28; 
zballs = 15+r(3,:)*15; balls = {}; D = {};
for n = 1:Nb
...
wavevel = 5; decayrate = 0.1; amplitude = 0.25; wavenum = 4;
